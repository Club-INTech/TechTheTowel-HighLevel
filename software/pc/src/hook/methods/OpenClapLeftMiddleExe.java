...
public class OpenClapLeftMiddleExe implements Executable
{
   
	 public OpenClapLeftMiddleExe()
     {
    ...
    public boolean execute(GameState<Robot> stateToConsider)
    {
    	try 
    	{
			...
			stateToConsider.robot.useActuator(ActuatorOrder.MID_LEFT_CLAP, false);
